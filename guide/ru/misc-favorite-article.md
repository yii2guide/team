...
* [Паттерны проектирования](https://habrahabr.ru/company/piter/blog/241323/)
...
* [RESTful API для сервера – делаем правильно (Часть 1)](https://habrahabr.ru/post/144011/)
* [RESTful API для сервера – делаем правильно (Часть 2)](https://habrahabr.ru/post/144259/)
* [7 вредных советов проектировщику REST API](https://habrahabr.ru/post/325884/)
* [Важные аспекты RESTful API для вашего проекта](https://habrahabr.ru/post/108993/)
...
* [REST API в Yii2 Часть 2. Практика. Создание, настройка проекта. Добавление RBAC.](https://www.youtube.com/watch?v=nToFdUdE2JI)
* [REST API в Yii2 Часть 3. Реализация API. Тестирование.](https://www.youtube.com/watch?v=Cp3gJRZM2mc)
* [Тестирование с PHPUnit и Codeception вообще и в Yii2](https://www.youtube.com/watch?v=gRmEpUYaS20)
* [Построение и тестирование REST API в Yii2](https://www.youtube.com/watch?v=jDj_JggZXsU)
...
* [Table - Vue.js Examples](https://vuejsexamples.com)
